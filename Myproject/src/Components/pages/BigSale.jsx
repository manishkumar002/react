    ...
    return (
        <div className='container'>
            <div class="row">
                ...
                <div class="col-sm-6 ">
                    <img src="https://i.pinimg.com/originals/9b/dd/6b/9bdd6b624abd25f926c129a3f2a894b1.jpg" data-aos="zoom-in-right" data-aos-duration="1500" class="img-thumbnail" alt='...' style={{ "height": "400px" }} />
                </div>
